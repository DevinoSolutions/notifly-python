...
from ..models.create_ms_teams_user_endpoint_dto_type import CreateMsTeamsUserEndpointDtoType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_ms_teams_user_endpoint_dto_context import CreateMsTeamsUserEndpointDtoContext
    from ..models.ms_teams_user_endpoint_dto import MsTeamsUserEndpointDto


T = TypeVar("T", bound="CreateMsTeamsUserEndpointDto")
...
class CreateMsTeamsUserEndpointDto:
    ...
    Attributes:
        ...
        integration_identifier (str): The identifier of the integration to use for this channel endpoint. Example:
            slack-prod.
        type_ (CreateMsTeamsUserEndpointDtoType): Type of channel endpoint Example: ms_teams_user.
        ...
        context (CreateMsTeamsUserEndpointDtoContext | Unset):
    ...
    type_: CreateMsTeamsUserEndpointDtoType
    endpoint: MsTeamsUserEndpointDto
    identifier: str | Unset = UNSET
    context: CreateMsTeamsUserEndpointDtoContext | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateMsTeamsUserEndpointDtoType(d.pop("type"))

        endpoint = MsTeamsUserEndpointDto.from_dict(d.pop("endpoint"))
        ...
        if isinstance(_context, Unset):
            ...
            context = CreateMsTeamsUserEndpointDtoContext.from_dict(_context)

        connection_identifier = d.pop("connectionIdentifier", UNSET)

        create_ms_teams_user_endpoint_dto = cls(
        ...
        create_ms_teams_user_endpoint_dto.additional_properties = d
        return create_ms_teams_user_endpoint_dto
