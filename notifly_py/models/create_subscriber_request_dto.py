...
if TYPE_CHECKING:
    from ..models.create_subscriber_request_dto_data_type_0 import CreateSubscriberRequestDtoDataType0


T = TypeVar("T", bound="CreateSubscriberRequestDto")
...
class CreateSubscriberRequestDto:
    ...
    Attributes:
        ...
        data (CreateSubscriberRequestDtoDataType0 | None | Unset): Additional custom data associated with the subscriber
    """
    ...
    data: CreateSubscriberRequestDtoDataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, CreateSubscriberRequestDtoDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> CreateSubscriberRequestDtoDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = CreateSubscriberRequestDtoDataType0.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CreateSubscriberRequestDtoDataType0 | None | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        create_subscriber_request_dto = cls(
        ...
        create_subscriber_request_dto.additional_properties = d
        return create_subscriber_request_dto
