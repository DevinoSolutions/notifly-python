...
from ..models.create_ms_teams_channel_endpoint_dto_type import CreateMsTeamsChannelEndpointDtoType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_ms_teams_channel_endpoint_dto_context import CreateMsTeamsChannelEndpointDtoContext
    from ..models.ms_teams_channel_endpoint_dto import MsTeamsChannelEndpointDto


T = TypeVar("T", bound="CreateMsTeamsChannelEndpointDto")
...
class CreateMsTeamsChannelEndpointDto:
    ...
    Attributes:
        ...
        integration_identifier (str): The identifier of the integration to use for this channel endpoint. Example:
            slack-prod.
        type_ (CreateMsTeamsChannelEndpointDtoType): Type of channel endpoint Example: ms_teams_channel.
        ...
        context (CreateMsTeamsChannelEndpointDtoContext | Unset):
    ...
    type_: CreateMsTeamsChannelEndpointDtoType
    endpoint: MsTeamsChannelEndpointDto
    identifier: str | Unset = UNSET
    context: CreateMsTeamsChannelEndpointDtoContext | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateMsTeamsChannelEndpointDtoType(d.pop("type"))

        endpoint = MsTeamsChannelEndpointDto.from_dict(d.pop("endpoint"))
        ...
        if isinstance(_context, Unset):
            ...
            context = CreateMsTeamsChannelEndpointDtoContext.from_dict(_context)

        connection_identifier = d.pop("connectionIdentifier", UNSET)

        create_ms_teams_channel_endpoint_dto = cls(
        ...
        create_ms_teams_channel_endpoint_dto.additional_properties = d
        return create_ms_teams_channel_endpoint_dto
