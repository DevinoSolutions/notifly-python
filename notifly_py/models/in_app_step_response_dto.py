...
if TYPE_CHECKING:
    ...
    from ..models.in_app_controls_metadata_response_dto import InAppControlsMetadataResponseDto
    from ..models.in_app_step_response_dto_variables import InAppStepResponseDtoVariables
    from ..models.step_issues_dto import StepIssuesDto


T = TypeVar("T", bound="InAppStepResponseDto")


@_attrs_define
class InAppStepResponseDto:
    """
    Attributes:
        controls (InAppControlsMetadataResponseDto):
        variables (InAppStepResponseDtoVariables): JSON Schema for variables, follows the JSON Schema standard
    ...
    control_values: InAppControlDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        controls = InAppControlsMetadataResponseDto.from_dict(d.pop("controls"))

        variables = InAppStepResponseDtoVariables.from_dict(d.pop("variables"))
        ...
        if isinstance(_control_values, Unset):
            ...
            control_values = InAppControlDto.from_dict(_control_values)
        ...
        in_app_step_response_dto.additional_properties = d
        return in_app_step_response_dto
