...
if TYPE_CHECKING:
    ...
    from ..models.custom_controls_metadata_response_dto import CustomControlsMetadataResponseDto
    from ..models.custom_step_response_dto_variables import CustomStepResponseDtoVariables
    from ..models.step_issues_dto import StepIssuesDto


T = TypeVar("T", bound="CustomStepResponseDto")
...
class CustomStepResponseDto:
    ...
    Attributes:
        ...
        variables (CustomStepResponseDtoVariables): JSON Schema for variables, follows the JSON Schema standard
    ...
    control_values: CustomControlDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        controls = CustomControlsMetadataResponseDto.from_dict(d.pop("controls"))

        variables = CustomStepResponseDtoVariables.from_dict(d.pop("variables"))
        ...
        if isinstance(_control_values, Unset):
            ...
            control_values = CustomControlDto.from_dict(_control_values)
        ...
        custom_step_response_dto.additional_properties = d
        return custom_step_response_dto
