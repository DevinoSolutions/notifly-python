...
if TYPE_CHECKING:
    ...
    from ..models.digest_controls_metadata_response_dto import DigestControlsMetadataResponseDto
    from ..models.digest_step_response_dto_variables import DigestStepResponseDtoVariables
    from ..models.step_issues_dto import StepIssuesDto


T = TypeVar("T", bound="DigestStepResponseDto")


@_attrs_define
class DigestStepResponseDto:
    """
    Attributes:
        controls (DigestControlsMetadataResponseDto):
        variables (DigestStepResponseDtoVariables): JSON Schema for variables, follows the JSON Schema standard
    ...
    control_values: DigestControlDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        controls = DigestControlsMetadataResponseDto.from_dict(d.pop("controls"))

        variables = DigestStepResponseDtoVariables.from_dict(d.pop("variables"))
        ...
        if isinstance(_control_values, Unset):
            ...
            control_values = DigestControlDto.from_dict(_control_values)
        ...
        digest_step_response_dto.additional_properties = d
        return digest_step_response_dto
