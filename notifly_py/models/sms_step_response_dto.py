...
if TYPE_CHECKING:
    from ..models.sms_control_dto import SmsControlDto
    from ..models.sms_controls_metadata_response_dto import SmsControlsMetadataResponseDto
    from ..models.sms_step_response_dto_variables import SmsStepResponseDtoVariables
    from ..models.step_issues_dto import StepIssuesDto


T = TypeVar("T", bound="SmsStepResponseDto")
...
class SmsStepResponseDto:
    ...
    Attributes:
        ...
        variables (SmsStepResponseDtoVariables): JSON Schema for variables, follows the JSON Schema standard
    ...
    control_values: SmsControlDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        controls = SmsControlsMetadataResponseDto.from_dict(d.pop("controls"))

        variables = SmsStepResponseDtoVariables.from_dict(d.pop("variables"))
        ...
        if isinstance(_control_values, Unset):
            ...
            control_values = SmsControlDto.from_dict(_control_values)
        ...
        sms_step_response_dto.additional_properties = d
        return sms_step_response_dto
