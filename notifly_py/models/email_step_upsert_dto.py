...
if TYPE_CHECKING:
    ...
    from ..models.email_step_upsert_dto_control_values_type_1 import EmailStepUpsertDtoControlValuesType1


T = TypeVar("T", bound="EmailStepUpsertDto")
...
class EmailStepUpsertDto:
    ...
    Attributes:
        ...
        control_values (EmailControlDto | EmailStepUpsertDtoControlValuesType1 | Unset): Control values for the Email
            step.
    """
    ...
    control_values: EmailControlDto | EmailStepUpsertDtoControlValuesType1 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.control_values, EmailControlDto):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_control_values(data: object) -> EmailControlDto | EmailStepUpsertDtoControlValuesType1 | Unset:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                control_values_type_0 = EmailControlDto.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            control_values_type_1 = EmailStepUpsertDtoControlValuesType1.from_dict(data)

            return control_values_type_1

        control_values = _parse_control_values(d.pop("controlValues", UNSET))

        email_step_upsert_dto = cls(
            name=name,
            type_=type_,
            field_id=field_id,
            step_id=step_id,
        ...
        email_step_upsert_dto.additional_properties = d
        return email_step_upsert_dto
