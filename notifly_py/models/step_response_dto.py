...
if TYPE_CHECKING:
    from ..models.controls_metadata_dto import ControlsMetadataDto
    from ..models.step_issues_dto import StepIssuesDto
    from ..models.step_response_dto_control_values import StepResponseDtoControlValues
    from ..models.step_response_dto_variables import StepResponseDtoVariables


T = TypeVar("T", bound="StepResponseDto")
...
class StepResponseDto:
    ...
    Attributes:
        ...
        variables (StepResponseDtoVariables): JSON Schema for variables, follows the JSON Schema standard
        ...
        control_values (StepResponseDtoControlValues | Unset): Control values for the step (alias for controls.values)
        issues (StepIssuesDto | Unset):
        step_resolver_hash (str | Unset): Hash identifying the deployed Cloudflare Worker for this step
    """

    controls: ControlsMetadataDto
    variables: StepResponseDtoVariables
    step_id: str
    field_id: str
    name: str
    slug: str
    ...
    control_values: StepResponseDtoControlValues | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        controls = ControlsMetadataDto.from_dict(d.pop("controls"))

        variables = StepResponseDtoVariables.from_dict(d.pop("variables"))
        ...
        control_values: StepResponseDtoControlValues | Unset
        if isinstance(_control_values, Unset):
            control_values = UNSET
        else:
            control_values = StepResponseDtoControlValues.from_dict(_control_values)
        ...
        step_response_dto.additional_properties = d
        return step_response_dto
