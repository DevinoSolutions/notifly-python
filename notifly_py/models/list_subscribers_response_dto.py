...
T = TypeVar("T", bound="ListSubscribersResponseDto")
...
class ListSubscribersResponseDto:
    """
    Attributes:
        data (list[SubscriberResponseDto]): List of returned Subscribers
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = SubscriberResponseDto.from_dict(data_item_data)
        ...
        list_subscribers_response_dto = cls(
            data=data,
            next_=next_,
            previous=previous,
        ...
        list_subscribers_response_dto.additional_properties = d
        return list_subscribers_response_dto
