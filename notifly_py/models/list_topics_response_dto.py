...
T = TypeVar("T", bound="ListTopicsResponseDto")
...
class ListTopicsResponseDto:
    """
    Attributes:
        data (list[TopicResponseDto]): List of returned Topics
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = TopicResponseDto.from_dict(data_item_data)
        ...
        list_topics_response_dto.additional_properties = d
        return list_topics_response_dto
