...
if TYPE_CHECKING:
    ...
    from ..models.in_app_step_upsert_dto_control_values_type_1 import InAppStepUpsertDtoControlValuesType1


T = TypeVar("T", bound="InAppStepUpsertDto")


@_attrs_define
class InAppStepUpsertDto:
    """
    Attributes:
        ...
        control_values (InAppControlDto | InAppStepUpsertDtoControlValuesType1 | Unset): Control values for the In-App
            step.
    """
    ...
    control_values: InAppControlDto | InAppStepUpsertDtoControlValuesType1 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.control_values, InAppControlDto):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_control_values(data: object) -> InAppControlDto | InAppStepUpsertDtoControlValuesType1 | Unset:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                control_values_type_0 = InAppControlDto.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            control_values_type_1 = InAppStepUpsertDtoControlValuesType1.from_dict(data)

            return control_values_type_1

        control_values = _parse_control_values(d.pop("controlValues", UNSET))

        in_app_step_upsert_dto = cls(
            name=name,
            type_=type_,
            field_id=field_id,
            step_id=step_id,
        ...
        in_app_step_upsert_dto.additional_properties = d
        return in_app_step_upsert_dto
