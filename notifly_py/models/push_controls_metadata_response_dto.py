...
if TYPE_CHECKING:
    ...
    from ..models.push_controls_metadata_response_dto_data_schema import PushControlsMetadataResponseDtoDataSchema
    from ..models.ui_schema import UiSchema


T = TypeVar("T", bound="PushControlsMetadataResponseDto")


@_attrs_define
class PushControlsMetadataResponseDto:
    """
    Attributes:
        values (PushControlDto):
        data_schema (PushControlsMetadataResponseDtoDataSchema | Unset): JSON Schema for data
        ui_schema (UiSchema | Unset):
    """

    values: PushControlDto
    data_schema: PushControlsMetadataResponseDtoDataSchema | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        values = PushControlDto.from_dict(d.pop("values"))

        _data_schema = d.pop("dataSchema", UNSET)
        data_schema: PushControlsMetadataResponseDtoDataSchema | Unset
        if isinstance(_data_schema, Unset):
            data_schema = UNSET
        else:
            data_schema = PushControlsMetadataResponseDtoDataSchema.from_dict(_data_schema)
        ...
        push_controls_metadata_response_dto = cls(
            values=values,
            data_schema=data_schema,
            ui_schema=ui_schema,
        )

        push_controls_metadata_response_dto.additional_properties = d
        return push_controls_metadata_response_dto
