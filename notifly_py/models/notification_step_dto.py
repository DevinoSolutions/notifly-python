...
if TYPE_CHECKING:
    ...
    from ..models.notification_step_data import NotificationStepData
    from ..models.reply_callback import ReplyCallback
    from ..models.step_filter_dto import StepFilterDto


T = TypeVar("T", bound="NotificationStepDto")


@_attrs_define
class NotificationStepDto:
    """
    Attributes:
        ...
        variants (list[NotificationStepData] | Unset):
    """
    ...
    variants: list[NotificationStepData] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _variants is not UNSET:
            ...
            for variants_item_data in _variants:
                variants_item = NotificationStepData.from_dict(variants_item_data)

                variants.append(variants_item)

        notification_step_dto = cls(
            field_id=field_id,
            uuid=uuid,
            name=name,
        ...
        notification_step_dto.additional_properties = d
        return notification_step_dto
