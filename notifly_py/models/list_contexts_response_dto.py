...
T = TypeVar("T", bound="ListContextsResponseDto")
...
class ListContextsResponseDto:
    """
    Attributes:
        data (list[GetContextResponseDto]): List of returned Contexts
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetContextResponseDto.from_dict(data_item_data)
        ...
        list_contexts_response_dto = cls(
            data=data,
            next_=next_,
            previous=previous,
        ...
        list_contexts_response_dto.additional_properties = d
        return list_contexts_response_dto
