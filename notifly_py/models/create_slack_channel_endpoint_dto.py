...
from ..models.create_slack_channel_endpoint_dto_type import CreateSlackChannelEndpointDtoType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_slack_channel_endpoint_dto_context import CreateSlackChannelEndpointDtoContext
    from ..models.slack_channel_endpoint_dto import SlackChannelEndpointDto


T = TypeVar("T", bound="CreateSlackChannelEndpointDto")
...
class CreateSlackChannelEndpointDto:
    ...
    Attributes:
        ...
        integration_identifier (str): The identifier of the integration to use for this channel endpoint. Example:
            slack-prod.
        type_ (CreateSlackChannelEndpointDtoType): Type of channel endpoint Example: slack_channel.
        ...
        context (CreateSlackChannelEndpointDtoContext | Unset):
    ...
    type_: CreateSlackChannelEndpointDtoType
    endpoint: SlackChannelEndpointDto
    identifier: str | Unset = UNSET
    context: CreateSlackChannelEndpointDtoContext | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateSlackChannelEndpointDtoType(d.pop("type"))

        endpoint = SlackChannelEndpointDto.from_dict(d.pop("endpoint"))
        ...
        if isinstance(_context, Unset):
            ...
            context = CreateSlackChannelEndpointDtoContext.from_dict(_context)

        connection_identifier = d.pop("connectionIdentifier", UNSET)

        create_slack_channel_endpoint_dto = cls(
        ...
        create_slack_channel_endpoint_dto.additional_properties = d
        return create_slack_channel_endpoint_dto
