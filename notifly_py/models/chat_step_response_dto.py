...
if TYPE_CHECKING:
    from ..models.chat_control_dto import ChatControlDto
    from ..models.chat_controls_metadata_response_dto import ChatControlsMetadataResponseDto
    from ..models.chat_step_response_dto_variables import ChatStepResponseDtoVariables
    from ..models.step_issues_dto import StepIssuesDto


T = TypeVar("T", bound="ChatStepResponseDto")
...
class ChatStepResponseDto:
    ...
    Attributes:
        ...
        variables (ChatStepResponseDtoVariables): JSON Schema for variables, follows the JSON Schema standard
    ...
    control_values: ChatControlDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        controls = ChatControlsMetadataResponseDto.from_dict(d.pop("controls"))

        variables = ChatStepResponseDtoVariables.from_dict(d.pop("variables"))
        ...
        if isinstance(_control_values, Unset):
            ...
            control_values = ChatControlDto.from_dict(_control_values)
        ...
        chat_step_response_dto.additional_properties = d
        return chat_step_response_dto
