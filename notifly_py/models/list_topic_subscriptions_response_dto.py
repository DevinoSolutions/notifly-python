...
if TYPE_CHECKING:
    from ..models.topic_subscription_response_dto import TopicSubscriptionResponseDto


T = TypeVar("T", bound="ListTopicSubscriptionsResponseDto")
...
class ListTopicSubscriptionsResponseDto:
    """
    Attributes:
        data (list[TopicSubscriptionResponseDto]): List of returned Topic Subscriptions
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = TopicSubscriptionResponseDto.from_dict(data_item_data)
        ...
        list_topic_subscriptions_response_dto = cls(
            data=data,
            next_=next_,
            previous=previous,
        ...
        list_topic_subscriptions_response_dto.additional_properties = d
        return list_topic_subscriptions_response_dto
