...
if TYPE_CHECKING:
    ...
    from ..models.throttle_control_dto import ThrottleControlDto
    from ..models.throttle_controls_metadata_response_dto import ThrottleControlsMetadataResponseDto
    from ..models.throttle_step_response_dto_variables import ThrottleStepResponseDtoVariables


T = TypeVar("T", bound="ThrottleStepResponseDto")


@_attrs_define
class ThrottleStepResponseDto:
    """
    Attributes:
        controls (ThrottleControlsMetadataResponseDto):
        variables (ThrottleStepResponseDtoVariables): JSON Schema for variables, follows the JSON Schema standard
    ...
    control_values: ThrottleControlDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        controls = ThrottleControlsMetadataResponseDto.from_dict(d.pop("controls"))

        variables = ThrottleStepResponseDtoVariables.from_dict(d.pop("variables"))
        ...
        if isinstance(_control_values, Unset):
            ...
            control_values = ThrottleControlDto.from_dict(_control_values)
        ...
        throttle_step_response_dto = cls(
            controls=controls,
            variables=variables,
            step_id=step_id,
            field_id=field_id,
        ...
        throttle_step_response_dto.additional_properties = d
        return throttle_step_response_dto
