...
T = TypeVar("T", bound="InboxActionDto")
...
class InboxActionDto:
    """
    Attributes:
        label (str): Label of the action button
        is_completed (bool): Whether the action has been completed
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inbox_action_dto = cls(
            label=label,
            is_completed=is_completed,
            redirect=redirect,
        )

        inbox_action_dto.additional_properties = d
        return inbox_action_dto
