...
T = TypeVar("T", bound="WebhookDeletedWorkflowDto")
...
class WebhookDeletedWorkflowDto:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_deleted_workflow_dto = cls(
            object_=object_,
        )

        webhook_deleted_workflow_dto.additional_properties = d
        return webhook_deleted_workflow_dto
