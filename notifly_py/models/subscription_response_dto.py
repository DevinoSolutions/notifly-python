...
if TYPE_CHECKING:
    ...
    from ..models.topic_dto import TopicDto


T = TypeVar("T", bound="SubscriptionResponseDto")
...
class SubscriptionResponseDto:
    """
    Attributes:
        field_id (str): The unique identifier of the subscription Example: 64f5e95d3d7946d80d0cb679.
        topic (TopicDto):
        subscriber (None | SubscriberDto): The subscriber information
        created_at (str): The creation date of the subscription Example: 2025-04-24T05:40:21Z.
        updated_at (str): The last update date of the subscription Example: 2025-04-24T05:40:21Z.
        identifier (str | Unset): The identifier of the subscription Example: tk=product-updates:si=subscriber-123.
        name (str | Unset): The name of the subscription Example: My Subscription.
        preferences (list[SubscriptionPreferenceDto] | Unset): The preferences for workflows in this subscription
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.subscriber, SubscriberDto):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        topic = TopicDto.from_dict(d.pop("topic"))

        def _parse_subscriber(data: object) -> None | SubscriberDto:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                subscriber_type_1 = SubscriberDto.from_dict(data)

                return subscriber_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SubscriberDto, data)

        subscriber = _parse_subscriber(d.pop("subscriber"))
        ...
        subscription_response_dto.additional_properties = d
        return subscription_response_dto
