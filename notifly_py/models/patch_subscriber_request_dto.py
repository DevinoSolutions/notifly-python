...
if TYPE_CHECKING:
    from ..models.patch_subscriber_request_dto_data_type_0 import PatchSubscriberRequestDtoDataType0


T = TypeVar("T", bound="PatchSubscriberRequestDto")
...
class PatchSubscriberRequestDto:
    ...
    Attributes:
        ...
        data (None | PatchSubscriberRequestDtoDataType0 | Unset): Additional custom data associated with the subscriber
    """
    ...
    data: None | PatchSubscriberRequestDtoDataType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, PatchSubscriberRequestDtoDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> None | PatchSubscriberRequestDtoDataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = PatchSubscriberRequestDtoDataType0.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PatchSubscriberRequestDtoDataType0 | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        patch_subscriber_request_dto = cls(
        ...
        patch_subscriber_request_dto.additional_properties = d
        return patch_subscriber_request_dto
