...
from ..models.notification_trigger_dto_type import NotificationTriggerDtoType
...
T = TypeVar("T", bound="NotificationTriggerDto")
...
class NotificationTriggerDto:
    """
    Attributes:
        type_ (NotificationTriggerDtoType): Type of the trigger
        identifier (str): Identifier of the trigger
        variables (list[NotificationTriggerVariable]): Variables of the trigger
        subscriber_variables (list[NotificationTriggerVariable] | Unset): Subscriber variables of the trigger
    """

    type_: NotificationTriggerDtoType
    identifier: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = NotificationTriggerDtoType(d.pop("type"))
        ...
        notification_trigger_dto.additional_properties = d
        return notification_trigger_dto
