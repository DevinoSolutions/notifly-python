...
if TYPE_CHECKING:
    from ..models.delay_control_dto import DelayControlDto
    from ..models.delay_controls_metadata_response_dto import DelayControlsMetadataResponseDto
    from ..models.delay_step_response_dto_variables import DelayStepResponseDtoVariables
    from ..models.step_issues_dto import StepIssuesDto


T = TypeVar("T", bound="DelayStepResponseDto")
...
class DelayStepResponseDto:
    ...
    Attributes:
        ...
        variables (DelayStepResponseDtoVariables): JSON Schema for variables, follows the JSON Schema standard
    ...
    control_values: DelayControlDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        controls = DelayControlsMetadataResponseDto.from_dict(d.pop("controls"))

        variables = DelayStepResponseDtoVariables.from_dict(d.pop("variables"))
        ...
        if isinstance(_control_values, Unset):
            ...
            control_values = DelayControlDto.from_dict(_control_values)
        ...
        delay_step_response_dto.additional_properties = d
        return delay_step_response_dto
