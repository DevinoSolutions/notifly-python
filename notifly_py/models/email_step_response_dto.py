...
if TYPE_CHECKING:
    ...
    from ..models.email_controls_metadata_response_dto import EmailControlsMetadataResponseDto
    from ..models.email_step_response_dto_variables import EmailStepResponseDtoVariables
    from ..models.step_issues_dto import StepIssuesDto


T = TypeVar("T", bound="EmailStepResponseDto")


@_attrs_define
class EmailStepResponseDto:
    """
    Attributes:
        controls (EmailControlsMetadataResponseDto):
        variables (EmailStepResponseDtoVariables): JSON Schema for variables, follows the JSON Schema standard
    ...
    control_values: EmailControlDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        controls = EmailControlsMetadataResponseDto.from_dict(d.pop("controls"))

        variables = EmailStepResponseDtoVariables.from_dict(d.pop("variables"))
        ...
        if isinstance(_control_values, Unset):
            ...
            control_values = EmailControlDto.from_dict(_control_values)
        ...
        email_step_response_dto.additional_properties = d
        return email_step_response_dto
