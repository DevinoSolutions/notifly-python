...
from ..models.create_webhook_endpoint_dto_type import CreateWebhookEndpointDtoType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_webhook_endpoint_dto_context import CreateWebhookEndpointDtoContext
...
class CreateWebhookEndpointDto:
    ...
    Attributes:
        ...
        integration_identifier (str): The identifier of the integration to use for this channel endpoint. Example:
            slack-prod.
        type_ (CreateWebhookEndpointDtoType): Type of channel endpoint Example: webhook.
        ...
        context (CreateWebhookEndpointDtoContext | Unset):
    ...
    type_: CreateWebhookEndpointDtoType
    endpoint: WebhookEndpointDto
    identifier: str | Unset = UNSET
    context: CreateWebhookEndpointDtoContext | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateWebhookEndpointDtoType(d.pop("type"))

        endpoint = WebhookEndpointDto.from_dict(d.pop("endpoint"))
        ...
        if isinstance(_context, Unset):
            ...
            context = CreateWebhookEndpointDtoContext.from_dict(_context)
