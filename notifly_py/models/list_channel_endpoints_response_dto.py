...
T = TypeVar("T", bound="ListChannelEndpointsResponseDto")
...
class ListChannelEndpointsResponseDto:
    """
    Attributes:
        data (list[GetChannelEndpointResponseDto]): List of returned Channel Endpoints
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetChannelEndpointResponseDto.from_dict(data_item_data)
        ...
        list_channel_endpoints_response_dto = cls(
            data=data,
            next_=next_,
            previous=previous,
        ...
        list_channel_endpoints_response_dto.additional_properties = d
        return list_channel_endpoints_response_dto
