...
from ...models.channel_connections_controller_list_channel_connections_channel import (
    ChannelConnectionsControllerListChannelConnectionsChannel,
)
from ...models.channel_connections_controller_list_channel_connections_order_direction import (
    ChannelConnectionsControllerListChannelConnectionsOrderDirection,
)
from ...models.error_dto import ErrorDto
from ...models.list_channel_connections_response_dto import ListChannelConnectionsResponseDto
...
def _get_kwargs(
    *,
    ...
    order_direction: ChannelConnectionsControllerListChannelConnectionsOrderDirection | Unset = UNSET,
    order_by: str | Unset = UNSET,
    include_cursor: bool | Unset = UNSET,
    subscriber_id: str | Unset = UNSET,
    channel: ChannelConnectionsControllerListChannelConnectionsChannel | Unset = UNSET,
...
) -> ErrorDto | ListChannelConnectionsResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = ListChannelConnectionsResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | ListChannelConnectionsResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        before (str | Unset):
        limit (float | Unset):
        order_direction (ChannelConnectionsControllerListChannelConnectionsOrderDirection |
            Unset):
        order_by (str | Unset):
        include_cursor (bool | Unset):
        subscriber_id (str | Unset):
        channel (ChannelConnectionsControllerListChannelConnectionsChannel | Unset):
...
def sync(
    *,
    ...
    Returns:
        ErrorDto | ListChannelConnectionsResponseDto | ValidationErrorDto | str
    """
