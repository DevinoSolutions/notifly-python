...
from ...models.create_channel_connection_request_dto import CreateChannelConnectionRequestDto
...
def _get_kwargs(
    *,
    body: CreateChannelConnectionRequestDto,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = GetChannelConnectionResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Create a channel connection
     ...
     Create a new channel connection for a resource for given integration. Only one channel connection is
