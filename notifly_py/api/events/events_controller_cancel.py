...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v1/events/trigger/{transaction_id}".format(
...
) -> ErrorDto | ValidationErrorDto | bool | str | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | ValidationErrorDto | bool | str]:
    return Response(
    ...
    *,
    ...
    """Cancel triggered event
        ...
        Using a previously generated transactionId during the event trigger,
         will cancel any active or pending workflows. This is useful to cancel active digests, delays
    etc...
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | ValidationErrorDto | bool | str
    """
