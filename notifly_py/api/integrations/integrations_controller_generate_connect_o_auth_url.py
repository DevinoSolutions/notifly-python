...
from ...models.generate_connect_oauth_url_request_dto import GenerateConnectOauthUrlRequestDto
...
def _get_kwargs(
    *,
    body: GenerateConnectOauthUrlRequestDto,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/integrations/channel-connections/oauth",
    }
...
def sync_detailed(
    *,
    ...
    """Generate OAuth URL for a workspace/tenant connection
     ...
     Generate an OAuth URL that creates a workspace or tenant-level channel connection (Slack workspace
