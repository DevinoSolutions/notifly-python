...
from ...models.link_channel_endpoint_request_dto import LinkChannelEndpointRequestDto
from ...models.link_channel_endpoint_response_dto import LinkChannelEndpointResponseDto
...
def _get_kwargs(
    *,
    body: LinkChannelEndpointRequestDto,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/integrations/channel-endpoints/link",
    }
...
) -> ErrorDto | LinkChannelEndpointResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = LinkChannelEndpointResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | LinkChannelEndpointResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Issue a URL to link a subscriber chat identity
     ...
     Returns a provider-specific URL the subscriber opens to link their chat identity. The integration
...
def sync(
    *,
    ...
    Returns:
        ErrorDto | LinkChannelEndpointResponseDto | ValidationErrorDto | str
    """
