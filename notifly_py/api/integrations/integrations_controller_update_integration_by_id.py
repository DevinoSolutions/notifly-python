...
from ...models.update_integration_request_dto import UpdateIntegrationRequestDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/v1/integrations/{integration_id}".format(
...
) -> Any | ErrorDto | IntegrationResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = IntegrationResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorDto | IntegrationResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | ErrorDto | IntegrationResponseDto | ValidationErrorDto | str
    """
