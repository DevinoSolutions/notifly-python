...
from ...models.configure_telegram_webhook_response_dto import ConfigureTelegramWebhookResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/integrations/{integration_identifier}/webhook/configure".format(
...
) -> ConfigureTelegramWebhookResponseDto | ErrorDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = ConfigureTelegramWebhookResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ConfigureTelegramWebhookResponseDto | ErrorDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Configure a chat integration webhook
     ...
     Registers the Notifly webhook URL with the chat provider for the specified integration. Telegram is
    the only supported provider initially.
...
def sync(
    ...
    *,
    ...
    Returns:
        ConfigureTelegramWebhookResponseDto | ErrorDto | ValidationErrorDto | str
    """
