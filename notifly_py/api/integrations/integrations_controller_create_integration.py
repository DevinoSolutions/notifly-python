...
from ...models.create_integration_request_dto import CreateIntegrationRequestDto
...
) -> ErrorDto | IntegrationResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 201:
        response_201 = IntegrationResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | IntegrationResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorDto | IntegrationResponseDto | ValidationErrorDto | str
    """
