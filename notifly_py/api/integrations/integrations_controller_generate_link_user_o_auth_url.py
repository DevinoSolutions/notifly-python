...
from ...models.generate_link_user_oauth_url_request_dto import GenerateLinkUserOauthUrlRequestDto
...
def _get_kwargs(
    *,
    body: GenerateLinkUserOauthUrlRequestDto,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/integrations/channel-endpoints/oauth",
    }
...
def sync_detailed(
    *,
    ...
    """Generate OAuth URL to link a subscriber user identity
     ...
     Generate an OAuth URL that links a specific subscriber to their chat identity (Slack user ID or MS
    Teams user OID).
