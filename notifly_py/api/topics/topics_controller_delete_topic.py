...
from ...models.delete_topic_response_dto import DeleteTopicResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v2/topics/{topic_key}".format(
...
) -> DeleteTopicResponseDto | ErrorDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = DeleteTopicResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteTopicResponseDto | ErrorDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DeleteTopicResponseDto | ErrorDto | ValidationErrorDto | str
    """
