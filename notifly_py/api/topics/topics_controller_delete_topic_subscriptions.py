...
from ...models.delete_topic_subscriptions_response_dto import DeleteTopicSubscriptionsResponseDto
...
def _get_kwargs(
    topic_key: str,
    *,
    body: DeleteTopicSubscriptionsRequestDto,
...
) -> DeleteTopicSubscriptionsResponseDto | ErrorDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = DeleteTopicSubscriptionsResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteTopicSubscriptionsResponseDto | ErrorDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DeleteTopicSubscriptionsResponseDto | ErrorDto | ValidationErrorDto | str
    """
