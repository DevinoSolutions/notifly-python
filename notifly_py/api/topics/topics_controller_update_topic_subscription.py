...
from ...models.update_topic_subscription_request_dto import UpdateTopicSubscriptionRequestDto
...
def _get_kwargs(
    ...
    identifier: str,
    *,
    body: UpdateTopicSubscriptionRequestDto,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v2/topics/{topic_key}/subscriptions/{identifier}".format(
...
) -> ErrorDto | SubscriptionResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = SubscriptionResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | SubscriptionResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update a topic subscription
     ...
     Update a subscription by its unique identifier for a topic. You can update the preferences and name
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | SubscriptionResponseDto | ValidationErrorDto | str
    """
