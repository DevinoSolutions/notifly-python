...
from ...models.subscription_details_response_dto import SubscriptionDetailsResponseDto
...
) -> ErrorDto | SubscriptionDetailsResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = SubscriptionDetailsResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | SubscriptionDetailsResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | SubscriptionDetailsResponseDto | ValidationErrorDto | str
    """
