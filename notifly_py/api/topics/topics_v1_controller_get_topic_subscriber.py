...
from ...models.topic_subscriber_dto import TopicSubscriberDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/topics/{topic_key}/subscribers/{external_subscriber_id}".format(
            topic_key=quote(str(topic_key), safe=""),
            external_subscriber_id=quote(str(external_subscriber_id), safe=""),
        ),
    }
...
) -> ErrorDto | TopicSubscriberDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = TopicSubscriberDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | TopicSubscriberDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | TopicSubscriberDto | ValidationErrorDto | str
    """
