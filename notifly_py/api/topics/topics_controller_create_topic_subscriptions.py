...
from ...models.create_subscriptions_response_dto import CreateSubscriptionsResponseDto
...
def _get_kwargs(
    topic_key: str,
    *,
    body: CreateTopicSubscriptionsRequestDto,
...
) -> CreateSubscriptionsResponseDto | ErrorDto | ValidationErrorDto | str | None:
    if response.status_code == 201:
        response_201 = CreateSubscriptionsResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CreateSubscriptionsResponseDto | ErrorDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        CreateSubscriptionsResponseDto | ErrorDto | ValidationErrorDto | str
    """
