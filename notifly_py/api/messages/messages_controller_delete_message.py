...
from ...models.delete_message_response_dto import DeleteMessageResponseDto
...
) -> DeleteMessageResponseDto | ErrorDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = DeleteMessageResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteMessageResponseDto | ErrorDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete a message
     ...
     Delete a message entity from the Notifly platform by **messageId**.
...
def sync(
    ...
    *,
    ...
    Returns:
        DeleteMessageResponseDto | ErrorDto | ValidationErrorDto | str
    """
