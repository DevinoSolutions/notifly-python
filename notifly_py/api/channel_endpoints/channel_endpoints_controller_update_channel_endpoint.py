...
from ...models.update_channel_endpoint_request_dto import UpdateChannelEndpointRequestDto
...
def _get_kwargs(
    identifier: str,
    *,
    body: UpdateChannelEndpointRequestDto,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/channel-endpoints/{identifier}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetChannelEndpointResponseDto.from_dict(response.json())
