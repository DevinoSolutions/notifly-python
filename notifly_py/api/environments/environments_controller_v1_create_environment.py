...
from ...models.create_environment_request_dto import CreateEnvironmentRequestDto
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> EnvironmentResponseDto | ErrorDto | ValidationErrorDto | str | None:
    if response.status_code == 201:
        response_201 = EnvironmentResponseDto.from_dict(response.json())
    ...
    if response.status_code == 402:
        response_402 = ErrorDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EnvironmentResponseDto | ErrorDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EnvironmentResponseDto | ErrorDto | ValidationErrorDto | str
    """
