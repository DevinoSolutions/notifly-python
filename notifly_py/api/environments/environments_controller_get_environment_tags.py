...
from ...models.get_environment_tags_dto import GetEnvironmentTagsDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v2/environments/{environment_id}/tags".format(
...
) -> ErrorDto | ValidationErrorDto | list[GetEnvironmentTagsDto] | str | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = GetEnvironmentTagsDto.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | ValidationErrorDto | list[GetEnvironmentTagsDto] | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | ValidationErrorDto | list[GetEnvironmentTagsDto] | str
    """
