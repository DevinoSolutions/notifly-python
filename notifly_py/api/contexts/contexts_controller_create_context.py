...
from ...models.create_context_request_dto import CreateContextRequestDto
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = GetContextResponseDto.from_dict(response.json())
    ...
    *,
    ...
    """Create a context
     ...
     Create a new context with the specified type, id, and data. Returns 409 if context already exists.
          **type** and **id** are required fields, **data** is optional, if the context already exists,
    it returns the 409 response
