...
from ...models.get_context_response_dto import GetContextResponseDto
from ...models.update_context_request_dto import UpdateContextRequestDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v2/contexts/{type_}/{id}".format(
...
) -> ErrorDto | GetContextResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = GetContextResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | GetContextResponseDto | ValidationErrorDto | str]:
    return Response(
    ...
    *,
    ...
    """Update a context
     ...
     Update the data of an existing context.
          **type** and **id** are required fields, **data** is required. Only the data field is updated,
    the rest of the context is not affected.
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | GetContextResponseDto | ValidationErrorDto | str
    """
