...
from ...models.update_environment_variable_request_dto import UpdateEnvironmentVariableRequestDto
...
def _get_kwargs(
    variable_key: str,
    *,
    body: UpdateEnvironmentVariableRequestDto,
...
def sync_detailed(
    ...
    *,
    ...
    """Update a variable
     ...
     Updates an existing environment variable. Providing `values` merges them into the existing per-
    environment values by `_environmentId`; envs not present in the request keep their stored value.
