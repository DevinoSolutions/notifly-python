...
from ...models.get_environment_variable_usage_response_dto import GetEnvironmentVariableUsageResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/environment-variables/{variable_key}/usage".format(
...
) -> Any | ErrorDto | GetEnvironmentVariableUsageResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = GetEnvironmentVariableUsageResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorDto | GetEnvironmentVariableUsageResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve a variable usage
     ...
     Returns the workflows that reference this environment variable via `{{env.KEY}}` in their step
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | ErrorDto | GetEnvironmentVariableUsageResponseDto | ValidationErrorDto | str
    """
