...
from ...models.generate_layout_preview_response_dto import GenerateLayoutPreviewResponseDto
from ...models.layout_preview_request_dto import LayoutPreviewRequestDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v2/layouts/{layout_id}/preview".format(
...
) -> ErrorDto | GenerateLayoutPreviewResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 201:
        response_201 = GenerateLayoutPreviewResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | GenerateLayoutPreviewResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | GenerateLayoutPreviewResponseDto | ValidationErrorDto | str
    """
