...
from ...models.duplicate_layout_dto import DuplicateLayoutDto
from ...models.error_dto import ErrorDto
from ...models.layout_response_dto import LayoutResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v2/layouts/{layout_id}/duplicate".format(
...
) -> ErrorDto | LayoutResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 201:
        response_201 = LayoutResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | LayoutResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Duplicate a layout
     ...
     Duplicates a layout by its unique identifier **layoutId**. This will create a new layout with the
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | LayoutResponseDto | ValidationErrorDto | str
    """
