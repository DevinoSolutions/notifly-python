...
from ...models.layout_response_dto_sort_field import LayoutResponseDtoSortField
from ...models.list_layout_response_dto import ListLayoutResponseDto
...
def _get_kwargs(
    *,
    ...
    order_by: LayoutResponseDtoSortField | Unset = UNSET,
...
) -> ErrorDto | ListLayoutResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = ListLayoutResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | ListLayoutResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order_by (LayoutResponseDtoSortField | Unset):
        query (str | Unset):
...
def sync(
    *,
    ...
    Returns:
        ErrorDto | ListLayoutResponseDto | ValidationErrorDto | str
    """
