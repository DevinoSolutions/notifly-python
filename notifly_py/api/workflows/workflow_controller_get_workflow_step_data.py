...
from ...models.step_response_dto import StepResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v2/workflows/{workflow_id}/steps/{step_id}".format(
...
) -> ErrorDto | StepResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = StepResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | StepResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | StepResponseDto | ValidationErrorDto | str
    """
