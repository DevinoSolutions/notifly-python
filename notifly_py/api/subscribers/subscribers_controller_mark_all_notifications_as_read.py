...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v2/subscribers/{subscriber_id}/notifications/read".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Mark all notifications as read
     ...
     Mark all in-app (inbox) notifications matching the specified filters as read. Supports context-based
    filtering.
