...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v2/subscribers/{subscriber_id}/notifications/archive".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Archive all notifications
     ...
     Archive all in-app (inbox) notifications matching the specified filters. Supports context-based
    filtering.
