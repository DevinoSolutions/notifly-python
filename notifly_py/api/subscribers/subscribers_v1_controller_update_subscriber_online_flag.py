...
from ...models.update_subscriber_online_flag_request_dto import UpdateSubscriberOnlineFlagRequestDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/subscribers/{subscriber_id}/online-status".format(
