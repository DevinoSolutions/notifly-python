...
from ...models.subscribers_controller_revert_notification_action_action_type import (
...
def _get_kwargs(
    subscriber_id: str,
    notification_id: str,
    action_type: SubscribersControllerRevertNotificationActionActionType,
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v2/subscribers/{subscriber_id}/notifications/{notification_id}/actions/{action_type}/revert".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Revert a notification action
     ...
     Revert a single in-app (inbox) notification's action (primary or secondary) to pending state by its
