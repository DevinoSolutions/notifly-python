...
from ...models.bulk_create_subscriber_response_dto import BulkCreateSubscriberResponseDto
from ...models.bulk_subscriber_create_dto import BulkSubscriberCreateDto
...
) -> BulkCreateSubscriberResponseDto | ErrorDto | ValidationErrorDto | str | None:
    if response.status_code == 201:
        response_201 = BulkCreateSubscriberResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BulkCreateSubscriberResponseDto | ErrorDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Bulk create subscribers
          ...
          Using this endpoint multiple subscribers can be created at once. The bulk API is limited to
    500 subscribers per request.
...
def sync(
    *,
    ...
    Returns:
        BulkCreateSubscriberResponseDto | ErrorDto | ValidationErrorDto | str
    """
