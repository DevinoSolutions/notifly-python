...
from ...models.update_subscriber_channel_request_dto import UpdateSubscriberChannelRequestDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/subscribers/{subscriber_id}/credentials".format(
    ...
    *,
    ...
    """Upsert provider credentials
     ...
     Upsert credentials for a provider such as **slack** and **FCM**.
          **providerId** is required field. This API creates **deviceTokens** or appends to the existing
    ones.
