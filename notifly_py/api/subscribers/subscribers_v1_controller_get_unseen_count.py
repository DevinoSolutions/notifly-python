...
from ...models.unseen_count_response import UnseenCountResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/subscribers/{subscriber_id}/notifications/unseen".format(
...
) -> ErrorDto | UnseenCountResponse | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = UnseenCountResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | UnseenCountResponse | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve unseen notifications count
     ...
     This API is deprecated, use v2 API instead. Retrieve unseen in-app notifications count for a
    subscriber by its unique key identifier **subscriberId**.

    Args:
        subscriber_id (str):
        seen (bool | Unset):  Default: False.
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | UnseenCountResponse | ValidationErrorDto | str
    """
