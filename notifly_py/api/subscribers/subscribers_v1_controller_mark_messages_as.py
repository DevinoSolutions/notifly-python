...
from ...models.message_mark_as_request_dto import MessageMarkAsRequestDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/subscribers/{subscriber_id}/messages/mark-as".format(
...
) -> ErrorDto | ValidationErrorDto | list[MessageResponseDto] | str | None:
    if response.status_code == 201:
        response_201 = []
        _response_201 = response.json()
        for response_201_item_data in _response_201:
            response_201_item = MessageResponseDto.from_dict(response_201_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | ValidationErrorDto | list[MessageResponseDto] | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update notifications state
     ...
     This API is deprecated, use v2 API instead. Update subscriber's multiple in-app notifications state
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | ValidationErrorDto | list[MessageResponseDto] | str
    """
