...
from ...models.subscribers_controller_complete_notification_action_action_type import (
...
def _get_kwargs(
    subscriber_id: str,
    notification_id: str,
    action_type: SubscribersControllerCompleteNotificationActionActionType,
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v2/subscribers/{subscriber_id}/notifications/{notification_id}/actions/{action_type}/complete".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Complete a notification action
     ...
     Mark a single in-app (inbox) notification's action (primary or secondary) as completed by its unique
