...
from ...models.remove_subscriber_device_token_request_dto import RemoveSubscriberDeviceTokenRequestDto
...
def _get_kwargs(
    ...
    provider_id: str,
    *,
    body: RemoveSubscriberDeviceTokenRequestDto,
...
def sync_detailed(
    ...
    *,
    ...
    """Remove a device token
     ...
     Remove exactly ONE **deviceToken** from the subscriber's **providerId** channel.
          Removing an absent token is a no-op. This NEVER clears the whole channel and leaves every
    other
          token intact. The token travels in the body because it may contain URL-hostile characters.
