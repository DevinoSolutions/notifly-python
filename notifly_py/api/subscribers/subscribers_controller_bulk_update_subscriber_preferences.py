...
from ...models.bulk_update_subscriber_preferences_dto import BulkUpdateSubscriberPreferencesDto
from ...models.error_dto import ErrorDto
from ...models.get_preferences_response_dto import GetPreferencesResponseDto
...
def _get_kwargs(
    subscriber_id: str,
    *,
    body: BulkUpdateSubscriberPreferencesDto,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v2/subscribers/{subscriber_id}/preferences/bulk".format(
...
) -> ErrorDto | ValidationErrorDto | list[GetPreferencesResponseDto] | str | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = GetPreferencesResponseDto.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | ValidationErrorDto | list[GetPreferencesResponseDto] | str]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | ValidationErrorDto | list[GetPreferencesResponseDto] | str
    """
