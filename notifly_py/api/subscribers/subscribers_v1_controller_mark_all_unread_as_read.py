...
from ...models.mark_all_message_as_request_dto import MarkAllMessageAsRequestDto
...
def _get_kwargs(
    subscriber_id: str,
    *,
    body: MarkAllMessageAsRequestDto,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/subscribers/{subscriber_id}/messages/mark-all".format(
...
) -> ErrorDto | ValidationErrorDto | float | str | None:
    if response.status_code == 201:
        response_201 = cast(float, response.json())
        return response_201
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | ValidationErrorDto | float | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update all notifications state
     ...
     This API is deprecated, use v2 API instead. Update all subscriber in-app notifications state such as
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | ValidationErrorDto | float | str
    """
