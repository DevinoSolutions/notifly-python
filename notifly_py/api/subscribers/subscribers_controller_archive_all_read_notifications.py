...
from ...models.update_all_subscriber_notifications_dto import UpdateAllSubscriberNotificationsDto
...
def _get_kwargs(
    subscriber_id: str,
    *,
    body: UpdateAllSubscriberNotificationsDto,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v2/subscribers/{subscriber_id}/notifications/read-archive".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Archive all read notifications
     ...
     Archive all read in-app (inbox) notifications matching the specified filters. Supports context-based
    filtering.
