...
from ...models.snooze_subscriber_notification_dto import SnoozeSubscriberNotificationDto
...
def _get_kwargs(
    ...
    notification_id: str,
    *,
    body: SnoozeSubscriberNotificationDto,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v2/subscribers/{subscriber_id}/notifications/{notification_id}/snooze".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Snooze a notification
     ...
     Snooze a specific in-app (inbox) notification by its unique identifier **notificationId** until a
    specified time.
