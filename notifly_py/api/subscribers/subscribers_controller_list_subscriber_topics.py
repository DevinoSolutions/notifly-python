...
from ...models.subscribers_controller_list_subscriber_topics_order_direction import (
...
def _get_kwargs(
    ...
    *,
    ...
    order_direction: SubscribersControllerListSubscriberTopicsOrderDirection | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v2/subscribers/{subscriber_id}/subscriptions".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        before (str | Unset):
        limit (float | Unset):
        order_direction (SubscribersControllerListSubscriberTopicsOrderDirection | Unset):
        order_by (str | Unset):
