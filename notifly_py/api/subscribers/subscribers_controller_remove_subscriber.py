...
from ...models.remove_subscriber_response_dto import RemoveSubscriberResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v2/subscribers/{subscriber_id}".format(
...
) -> ErrorDto | RemoveSubscriberResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = RemoveSubscriberResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | RemoveSubscriberResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete a subscriber
     ...
     Deletes a subscriber entity from the Notifly platform along with associated messages, preferences,
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | RemoveSubscriberResponseDto | ValidationErrorDto | str
    """
