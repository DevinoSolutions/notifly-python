...
from ...models.list_subscribers_response_dto import ListSubscribersResponseDto
from ...models.subscribers_controller_search_subscribers_order_direction import (
...
def _get_kwargs(
    *,
    ...
    order_direction: SubscribersControllerSearchSubscribersOrderDirection | Unset = UNSET,
...
) -> ErrorDto | ListSubscribersResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = ListSubscribersResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | ListSubscribersResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        before (str | Unset):
        limit (float | Unset):
        order_direction (SubscribersControllerSearchSubscribersOrderDirection | Unset):
        order_by (str | Unset):
...
def sync(
    *,
    ...
    Returns:
        ErrorDto | ListSubscribersResponseDto | ValidationErrorDto | str
    """
