...
from ...models.feed_response_dto import FeedResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/subscribers/{subscriber_id}/notifications/feed".format(
...
) -> ErrorDto | FeedResponseDto | ValidationErrorDto | str | None:
    if response.status_code == 200:
        response_200 = FeedResponseDto.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDto | FeedResponseDto | ValidationErrorDto | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve subscriber notifications
     ...
     This API is deprecated, use v2 API instead. Retrieve subscriber in-app notifications by its unique
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorDto | FeedResponseDto | ValidationErrorDto | str
    """
